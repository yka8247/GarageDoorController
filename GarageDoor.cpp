...
STATE_DEFINE(GarageDoor, upward_operation, NoEventData) {
...
//		is_operating = FALSE;			// clear the state flag
	InternalEvent(ST_DOOR_OPEN);	// move on to the next state
//	}
}
...
STATE_DEFINE(GarageDoor, downward_operation, NoEventData) {
...
//		delay(500);				// poll every 500 ms
//		if (!data->overcurrent) {
//			std::cout << "OVERCURRENT SIGNAL HAS BEEN REMOVED" << std::endl;
//			overcurrent = FALSE;
//		}
//	}
//	InternalEvent(ST_DOWNWARD_OPERATION);
