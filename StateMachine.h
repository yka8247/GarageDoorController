...
public:
	...
	///	Constructor.
	///	@param [ maxStates ] - the maximum number of state machine states.
...
protected:
	...
	/// @param [ newState ] - the state machine state to transition to.
	...
	/// @param [ newState ] - the state machine state to transition to.
	/// @param [ pData ] - the event data sent to the state.
